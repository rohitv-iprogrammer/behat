...
@property_layoutBlue0RescounterHotelDevDesktop_clickToSeeRoomOptionsOnHotels2_dev @dev
...
@property_layoutBlue0RescounterHotelDevDesktop_clickToSeeHotelDetailsOnHotels2_dev @dev
Scenario: Click to see hotel details on hotels2
Given I am on "/hotels2/las-vegas-nv/golden-nugget-hotel-casino-las-vegas-nv/61239eb/?autoQA=true"
Then I should see hotel details

@property_layoutBlue0RescounterHotelDevDesktop_clickToSeeHotelReviewsOnHotels2_dev @dev
Scenario: Click to see hotel reviews on hotels 2
Given I am on "/hotels2/las-vegas-nv/golden-nugget-hotel-casino-las-vegas-nv/61239eb/?autoQA=true"
When I click on "reviews"
Then I should see text matching "Reviews"

@property_layoutBlue0RescounterHotelDevDesktop_CheckAllAminityIconsOnHotels2_dev @dev
...
@property_layoutBlue0RescounterHotelDevDesktop_clickToSeeeHotelReviewsFilterOnHotels2_dev @dev
Scenario: Click to see hotel reviews on hotels 2
Given I am on "/hotels2/las-vegas-nv/golden-nugget-hotel-casino-las-vegas-nv/61239eb/?autoQA=true"
...
@property_layoutBlue0RescounterHotelDevDesktop_HotelReviewsFilter2_dev @mobile @dev @StoryM:#16309
