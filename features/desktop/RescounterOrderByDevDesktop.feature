#Feature for dev scenarios desktop only
Feature: Rescounter order by dev desktop
...
@search_rescounterOrderByDevDesktop_OrderByPriceMinMax_dev @dev @Story:#15231
...
@search_rescounterOrderByDevDesktop_OrderByPriceMaxMin_dev @dev @Story:#15231
