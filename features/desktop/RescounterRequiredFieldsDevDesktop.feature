#Feature for dev scenarios only desktop
Feature: Rescounter required fields dev desktop
In order to interact with the site
As a customer
I must be able to know the required fields

@book_rescounterRequiredFieldsDevDesktop_verifyRequiredFields_dev @dev
