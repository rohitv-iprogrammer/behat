...
Feature: Rescounter hotel2 mobile
In order I am on hotel page
As a costumer
I must be able to see a hotel and room information

@property_rescounterHotel2Mobile_clickToSeeHotelReviews_M @mobile
...
@property_rescounterHotel2Mobile_CheckAllAminityIcons_M @mobile
...
@property_rescounterHotel2Mobile_clickToSeeRoomOptionsOnHotels2_M @mobile
...
@property_rescounterHotel2Mobile_showMoreReviewsOnHotels2_M @mobile
